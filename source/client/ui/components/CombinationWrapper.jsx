...
class CombinationWrapper extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <div
        className={`comb_wrapper ${attribute.name}-comb`}
        style={{height: (combination.attributeID === attribute.id) ? 389 : 76}}
      >
        {
          combination.attributeID === attribute.id ?
              ...
              </div>
              {
                combination.type === "COMBINATION" ?
                  <>
                    ...
                    <button
                      onClick={() => createCombination(tableID, combination.attributeID, combination.conditionID, "COMBINATION333", [
                        {
                          conditionID: "type_of_user_id",
                          instanceID: "1488",
                        },
                      ])}>Add comb for comb
                    </button>
            ...
            <div className="comb_opacity">
              {
                condition.instances.map(instance => {
                  return (
                    <div
                      className="comb_item"
                      key={instance.id}
